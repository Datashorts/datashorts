...
import DynamicResearcherResponse from './DynamicResearcherResponse'
      ...
      <div className="space-y-4">
        ...
        {analysisResult && (
          <>
            ...
            ) : taskResult.next === 'researcher' ? (
              <DynamicResearcherResponse
                initialResponse={analysisResult}
                connectionId={connectionId || response.connectionId}
                userQuery={response.userQuery || response.message || analysisResult.userQuery || ''}
                reconstructedSchema={response.reconstructedSchema || analysisResult.reconstructedSchema || []}
                refreshInterval={5000} // Default to 5 seconds
              />
            ) : (
              <>
